...
recebePorHora    = float(input("Quanto você ganha por hora? "))
horasTrabalhadas = int(input("Quantas horas trabalhadas no mês? "))

salarioTotal = (recebePorHora * horasTrabalhadas)
print(salarioTotal)
...
mensagem = "SALÁRIO BRUTO: %f , \n INSS: %f, \n sindicato: %f \n ----SALÁRIO LÍQUIDO--- \n Desconto:\n IR: R$ %f , \n Sindicato: R$ %f , \n Salário Liquido: R$ %f " % (salarioTotal, inss, sindicato, ir, sindicato, salarioLiquido)
print(mensagem)
